...
extension CategoryManager {
    ...
    public func addCategoryModel(_ model: CategoryModel, callback: @escaping (Error?) -> Void) {
    ...
    public func deleteCategoryMoel(_ model: CategoryModel, callback: @escaping (Error?) -> Void) {
        self.isolationQueue.async(flags: .barrier) {
    ...
    public func getCategoryModels() -> [CategoryModel]? {
