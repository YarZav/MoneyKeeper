...
extension CardManager {
    ...
    public func addCardModel(_ model: CardModel, callback: @escaping (Error?) -> Void) {
    ...
    public func getCardModels() -> [CardModel]? {
    ...
    public func deleteCardMoel(_ model: CardModel, callback: @escaping (Error?) -> Void) {
        self.isolationQueue.async(flags: .barrier) {
